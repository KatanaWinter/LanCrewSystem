...
<body>
    ...
    <section class="body">
        ...
        <h2 class="center">Stylesheet</h2>

        <section class="navFilter">
            <div class="navFilter-item"><a href="">test</a></div>
            <div class="navFilter-item"><a href="">test2</a></div>
            <div class="navFilter-item"><a href="">test3</a></div>
        </section>
